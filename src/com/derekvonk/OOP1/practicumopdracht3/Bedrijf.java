 ...
 * @author Derek Vonk - 500704534 - IDI101 - Practicum Opdracht 3 - Object
 * Oriented Programming 1 - Docent Michel Mercera
 */
public class Bedrijf {
    ...
    /**
     * Method outputs combination of child classes toString() and salaris()
     * first checks if objects in Bedrijf's arraylist are an instance of
    ...
    public void betaalSalarissen() {
        ...
        System.out.println("--------------------------------------------\n"
                + " !! Gewerkte Uren en Bonussen weer op nul !!");
    ...
    /**
     * Method returns a String representation of Bedrijf object and counts
